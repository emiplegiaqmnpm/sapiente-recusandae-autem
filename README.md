[![npm](https://img.shields.io/npm/v/@emiplegiaqmnpm/sapiente-recusandae-autem.svg)](https://www.npmjs.com/package/@emiplegiaqmnpm/sapiente-recusandae-autem) ![downloads](https://img.shields.io/npm/dt/@emiplegiaqmnpm/sapiente-recusandae-autem.svg) [![CI](https://github.com/emiplegiaqmnpm/sapiente-recusandae-autem/actions/workflows/ci.yml/badge.svg)](https://github.com/emiplegiaqmnpm/sapiente-recusandae-autem/actions)
...
This package is used to _display_ existing PDFs. If you wish to _create_ PDFs using React, you may be looking for [@@emiplegiaqmnpm/sapiente-recusandae-autem/renderer](https://www.npmjs.com/package/@@emiplegiaqmnpm/sapiente-recusandae-autem/renderer).

## tl;dr

- Install by executing `npm install @emiplegiaqmnpm/sapiente-recusandae-autem` or `yarn add @emiplegiaqmnpm/sapiente-recusandae-autem`.
- Import by adding `import { Document } from '@emiplegiaqmnpm/sapiente-recusandae-autem'`.
...
[Online demo](https://projects.wojtekmaj.pl/@emiplegiaqmnpm/sapiente-recusandae-autem/) is also available!
...
- [v6.x](https://github.com/emiplegiaqmnpm/sapiente-recusandae-autem/blob/v6.x/README.md)
- [v5.x](https://github.com/emiplegiaqmnpm/sapiente-recusandae-autem/blob/v5.x/README.md)
- [v4.x](https://github.com/emiplegiaqmnpm/sapiente-recusandae-autem/blob/v4.x/README.md)
- [v3.x](https://github.com/emiplegiaqmnpm/sapiente-recusandae-autem/blob/v3.x/README.md)
- [v2.x](https://github.com/emiplegiaqmnpm/sapiente-recusandae-autem/blob/v2.x/README.md)
- [v1.x](https://github.com/emiplegiaqmnpm/sapiente-recusandae-autem/blob/v1.x/README.md)
...
Add React-PDF to your project by executing `npm install @emiplegiaqmnpm/sapiente-recusandae-autem` or `yarn add @emiplegiaqmnpm/sapiente-recusandae-autem`.
...
```ts
import { pdfjs } from '@emiplegiaqmnpm/sapiente-recusandae-autem';
...
import { Document, Page } from '@emiplegiaqmnpm/sapiente-recusandae-autem';
...
Check the [sample directory](https://github.com/emiplegiaqmnpm/sapiente-recusandae-autem/tree/main/sample) in this repository for a full working example. For more examples and more advanced use cases, check [Recipes](https://github.com/emiplegiaqmnpm/sapiente-recusandae-autem/wiki/Recipes) in [React-PDF Wiki](https://github.com/emiplegiaqmnpm/sapiente-recusandae-autem/wiki/).
...
```ts
import '@emiplegiaqmnpm/sapiente-recusandae-autem/dist/Page/AnnotationLayer.css';
```
...
```ts
import '@emiplegiaqmnpm/sapiente-recusandae-autem/dist/Page/TextLayer.css';
```
...
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className          | Class name(s) that will be added to rendered element along with the default `@emiplegiaqmnpm/sapiente-recusandae-autem__Document`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | n/a                                                   | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                   |
...
| className                      | Class name(s) that will be added to rendered element along with the default `@emiplegiaqmnpm/sapiente-recusandae-autem__Page`.                                                                                                                                                                                                   | n/a                                                 | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                 |
...
| Prop name     | Description                                                                                                                                        | Default value | Example values                                                                                                                                                                                                                                                              |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className     | Class name(s) that will be added to rendered element along with the default `@emiplegiaqmnpm/sapiente-recusandae-autem__Outline`.                                                  | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                  |
...
| Prop name   | Description                                                                                                                                  | Default value | Example values                                                                                                                                             |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className   | Class name(s) that will be added to rendered element along with the default `@emiplegiaqmnpm/sapiente-recusandae-autem__Thumbnail`.                                          | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul> |
...
- [React-PDF Wiki](https://github.com/emiplegiaqmnpm/sapiente-recusandae-autem/wiki/)
...
Thank you to all our sponsors! [Become a sponsor](https://opencollective.com/@emiplegiaqmnpm/sapiente-recusandae-autem-wojtekmaj#sponsor) and get your image on our README on GitHub.

<a href="https://opencollective.com/@emiplegiaqmnpm/sapiente-recusandae-autem-wojtekmaj#sponsors" target="_blank"><img src="https://opencollective.com/@emiplegiaqmnpm/sapiente-recusandae-autem-wojtekmaj/sponsors.svg?width=890"></a>

### Backers

Thank you to all our backers! [Become a backer](https://opencollective.com/@emiplegiaqmnpm/sapiente-recusandae-autem-wojtekmaj#backer) and get your image on our README on GitHub.

<a href="https://opencollective.com/@emiplegiaqmnpm/sapiente-recusandae-autem-wojtekmaj#backers" target="_blank"><img src="https://opencollective.com/@emiplegiaqmnpm/sapiente-recusandae-autem-wojtekmaj/backers.svg?width=890"></a>

### Top Contributors

Thank you to all our contributors that helped on this project!

![Top Contributors](https://opencollective.com/@emiplegiaqmnpm/sapiente-recusandae-autem/contributors.svg?width=890&button=false)
